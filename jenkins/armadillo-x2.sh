...
swdesc_boot --board iot-g4-g4-eva imx-boot_yakushima-eva
swdesc_boot --board iot-g4-es1 imx-boot_yakushima-es1
swdesc_boot --board iot-g4-es2 imx-boot_yakushima-es1
